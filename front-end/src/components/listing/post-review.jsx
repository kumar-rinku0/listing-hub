...
const PostReview = ({ createdBy, id, setListing }) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`/api/chat/listingId/${id}`, chat)
      .then((res) => {
  ...
  const handleDeleteClick = (id, createdBy) => {
    axios
      .post(`/api/listings/${id}/${createdBy}`)
      .then((res) => {
        console.log(res.data);
    ...
    return (
      <div className="post-review">
        <Button
          type="button"
          variant="outlined"
          onClick={() => handleDeleteClick(id, createdBy)}
        >
          Delete Listing
        </Button>
    ...
    return (
      <div className="post-review">
        <form onSubmit={handleSubmit} className="post-review-form">
          ...
          <div className="div2">
            <Button variant="outlined" type="button" onClick={renderReviewForm}>
              close
            </Button>
